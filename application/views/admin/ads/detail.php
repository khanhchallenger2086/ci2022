        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="md-form mb-3">
                    ...
                    <label for="vn_name">Tên ADS</label>
                ...
                <div class="md-form mb-3">
                    ...
                    <label for="link">Link ADS Hoặc Chi tiết</label>
                ...
                <div class="form-group">
                    ...
                    <div class="showFile">
                        ...
                        <?php } else { ?>
                            <img class="image-style" id="profile-img-tag" src="<?= base_url('uploads/images/ads/' . $info->image_link) ?>" alt="No-Img">
                        <?php } ?>
                    </div>
                </div> 
                <div class="text-center">
                    <button type="submit" class="btn btn-primary mr-3">Lưu lại</button><a class="btn btn-light"
                        href="<?= base_url('admincp/ads') ?>">Trở về</a>
                </div>
            </form>
        </div>
    </section>
