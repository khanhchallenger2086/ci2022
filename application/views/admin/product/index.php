                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <div class="text-left" style="min-width: 250px">
                                        <a data-fancybox="gallery" href="<?= base_url('uploads/images/'.$name_class.'/large/' . $row->image_link) ?>"><img src="<?= base_url('uploads/images/'.$name_class.'/large/' . $row->image_link) ?>"/></a> 
                                        <h5><?= $row->vn_name ?></h5>
                                    </div>
                                </th>
                                ...
                                <th scope="col">
                                    <div class="action-zone">
                                        ...
                                        <a class="action btn-light active-single">
                                            <span>Hiển thị</span>
                                            <i class="mdi mdi-eye-outline" onclick="action_item(<?=$row->id?>, 'enable', '<?= base_url('admincp/'.$name_class.'/config') ?>', '<?= $name_item ?>');"></i>
                                        </a>
                                        <a class="action btn-light private-single">
                                            <span>Ẩn</span>
                                            <i class="mdi mdi-crosshairs-gps" onclick="action_item(<?=$row->id?>, 'disable', '<?= base_url('admincp/'.$name_class.'/config') ?>', '<?= $name_item ?>');"></i>
                                        </a>
                                        <a class="action btn-light delete-single">
                                            <span>Xóa</span>
                                            <i class="mdi mdi-trash-can-outline" onclick="action_item(<?=$row->id?>, 'del', '<?= base_url('admincp/'.$name_class.'/config') ?>', '<?= $name_item ?>');"></i>
                                        </a>
                                    </div>
                                </th>
                            </tr>
