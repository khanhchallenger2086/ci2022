        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="md-form mb-3">
                    ...
                    <label for="vn_name">Tên trang tĩnh</label>
                ...
                <div class="md-form mb-3">
                    <input name="title" value="<?= isset($info->title) ? $info->title : set_value('title') ?>"  type="text" class="form-control form-control-sm" id="vn_keyword" />
                    <label for="title">Title</label>
                </div> 
                <div class=" mb-3">
                    <label class="label-ck" for="sapo">Mô tả trang tĩnh</label>
                ...
                <div class="mb-3">
                    ...
                    <label class="label-ck" for="editor">Chi tiết trang tĩnh</label>
                 ...
                 <div class="form-group">
                    <label class="label-ck">Hình Ảnh (Kích thước chuẩn 500x310px)</label>
                    ...
                    <div class="showFile">
                        ...
                        <?php } else { ?>
                            <img class="image-style" id="profile-img-tag" src="<?= base_url('uploads/images/staticpage/small/' . $info->image_link) ?>" alt="No-Img">
                        <?php } ?>
                    </div>
                </div> 
                <div class="text-center">
                    <button type="submit" class="btn btn-primary mr-3">Lưu lại</button><a class="btn btn-light"
                        href="<?= base_url('admincp/staticpage') ?>">Trở về</a>
                </div>
            </form>
        </div>
    </section>
