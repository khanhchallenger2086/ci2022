    ...
    <section class="add-item">
        <div class="container-fluid">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <input type="checkbox" name="is_show_product_top" value="1" <?= @$info->is_show_product_top == 1? 'checked' : '' ?>/><span class="checkmark"></span><span>Hiển thị các sản phẩm của danh mục ở trang home</span>
                            </label>
                        </div>
                        <!-- <div class="col-md-4 col-sm-6">
                            <label class="check-box mb-2">
                            <input type="checkbox" name="is_show_product_bottom" value="1" <?= @$info->is_show_product_bottom == 1? 'checked' : '' ?>/><span class="checkmark"></span>Hiển thị các sản phẩm của danh mục ở trang chủ vị trí Bottom
                            </label>
                        </div> -->
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="label-ck">Hình Ảnh (Kích thước chuẩn: 300x200px)</label>
                    ...
                    <div class="showFile">
                        ...
                        <?php } else { ?>
                            <img class="image-style" id="profile-img-tag" src="<?= base_url('uploads/images/'.$name_class.'/small/' . $info->image_link) ?>" alt="No-Img">
                        <?php } ?>
                    </div>
                </div>             
